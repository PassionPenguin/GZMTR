...
window.initTheme = () => {
    android.getPref("theme") === "black" || GET_("dark") === "true" ? (document.documentElement.classList.add('dark-theme'), window.isDark = true) : document.documentElement.classList.add(android.getPref("theme") === "pink" ? "pink-theme" : android.getPref("theme") === "yellow" ? "yellow-theme" : android.getPref("theme") === "green" ? "green-theme" : android.getPref("theme") === "blue" ? "blue-theme" : "light-theme");

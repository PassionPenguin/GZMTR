...
window.initTheme = () => {
    android.getPref("theme") === "black" || GET_("dark") === "true" ? document.documentElement.classList.add('dark-theme') : document.documentElement.classList.add(android.getPref("theme") === "pink" ? "pink-theme" : android.getPref("theme") === "yellow" ? "yellow-theme" : android.getPref("theme") === "green" ? "green-theme" : android.getPref("theme") === "blue" ? "blue-theme" : "light-theme");
...
window.initLanguage = (type) => {
    if (type === "init") {
        ...
        for (let i = 0; i < r.length; i++) {
            if (r[i].getAttribute("data-stringid") === "cur") r[i].innerText = lN[l.indexOf(cL)]; else if (r[i].getAttribute("data-stringid") === "curTheme") r[i].innerText = android.getPref("Theme") === "" ? f_name[27][l.indexOf(cL)] : android.getPref("Theme"); else {
        ...
        r = $("#ThemeChoser li");
        for (let i = 0; i < r.length; i++) r[i].onclick = function () {
            android.storeStringPref("theme", array("white", "black", "pink", "yellow", "green", "blue")[i]);

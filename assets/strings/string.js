...
window.string = {
    ...
    transferInfo: [["同台轉乘", "同台换乘", "対面乗り換え", "동일한 플랫폼에서 전송", "Cross-platform Transfer"], ["通道轉乘", "通道换乘", "通路でお乗り換え", "채널 전송", "Transfer via passage"], ["節點轉乘", "节点换乘", "ノードでお乗り換え", "노드 전송", "Transfer via node"], ["站廳轉乘", "站厅换乘", "ホールでお乗り換え", "역 이동", "Transfer via hall"], ["出站轉乘", "出站转乘", "改札で乗り換え", "", "Transfer after exiting"]],

...
window.theme = [
    ...
    ["细柳綠", "细柳绿", "裏柳", "초록", "Grass"]];
window.string = {
    infoDesc: ["简介信息", "简介信息", "案内", "안내", "Info"],
    facilityDesc: ["车站设施", "车站设施", "ファシリティーズ", "역 시설", "Facilities"],
    ...
    structureDesc: ["车站结构", "车站结构", "駅の結構", "스테이션 구조", "Structure Type"],
    structureInfo: [["地下车站", "地下车站", "地下駅", "지하역", "Underground Station"], ["地面车站", "地面车站", "地面駅", "지상 역", "Ground Station"], ["高架车站", "高架车站", "高架駅", "고가 역", "Overground Station"]],
    platformDesc: ["月台类型", "月台类型", "ホーム　タイプ", "플랫폼 유형", "Platform Type"],
    platformInfo: [["岛式站台", "岛式站台", "アイランド　ホーム", "섬 플랫폼", "Island Platform"], ["侧式站台", "侧式站台", "サイド　ホーム", "사이드 플랫폼", "Side Platform"], ["双岛式站台", "双岛式站台", "ダブル　アイランド　ホーム", "더블 아일랜드 플랫폼", "DblIsland Platform"], ["双侧式站台", "双侧式站台", "ダブル　サイド　ホーム", "양면 플랫폼", "DblSide Platform"], ["完全混合式站台", "完全混合式站台", "ミクス　ホーム", "완전 하이브리드 플랫폼", "Mixed Platform"], ["西班牙式站台", "西班牙式站台", "ホーム", "스페인어 플랫폼", "Spanish solution"], ["分离岛式站台", "分离岛式站台", "ホーム", "분리 된 섬 플랫폼", "Split Platform"]],
    hallDesc: ["站厅类型", "站厅类型", "ホール　タイプ", "역 홀 타입", "Hall Type"],
    hallInfo: [["地下站厅", "地下站厅", "地下ホール", "지하철역 홀", "Underground Station Hall"], ["地面站厅", "地面站厅", "地面ホール", "지상국 홀", "Ground Station Hall"], ["高架站厅", "高架站厅", "高架ホール", "높은 역 홀", "Overground Station Hall"]],
    transferDesc: ["换乘方式", "换乘方式", "乗り換え方式", "전송 방법", "Transfer Type"],
    transferInfo: [["同台换乘", "同台换乘", "ホームでお乗り換え", "동일한 플랫폼에서 전송", "Transfer at the opposite"], ["通道换乘", "通道换乘", "通路でお乗り換え", "채널 전송", "Transfer via passage"], ["站厅换乘", "站厅换乘", "ホールでお乗り換え", "역 이동", "Transfer via hall"]],
    exitNum: ["出口数量", "出口数量", "出口の数量", "수출 횟수", "Exits Num"],
    FirstTrainDesc: ["首班车", "首班车", "始発時間", "첫 열차", "First Train Time"],
    LastTrainDesc: ["末班车", "末班车", "終電時間", "末班车", "Last Train Time"],
    serviceTimeDesc: ["服务时间", "服务时间", "服務時間", "서비스 시간", "Service Time"],
    structureName: ["结构", "结构", "結構", "구조", "Structure"],
    exitName: ["出入口信息", "出入口信息", "出入口の情報", "출입국 정보", "Exits"],
    usageName: ["客流情况", "客流情况", "客流の情報", "여객 흐름", "Passengers Flow"],
    historyName: ["历史", "历史", "歴史", "연혁", "History"],
    futureExName: ["未来拓展", "未来拓展", "未來エクスパンション", "향후 확장", "Future Expansion"],
    ...
    removeCookies: ["清除一切用戶設置", "清理一切用户设置", "全部ユーザー設定を消去する", "모든 사용자 설정 지우기", "Remove all user preferences"],
    loading: ["加载中..", "加载中..", "ロード中..", "로드 중입니다 ..", "Loading.."],
    true: ["确定", "确定", "確認", "확인하다", "Confirm"],
